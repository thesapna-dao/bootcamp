...
WebUI.click(findTestObject('Object Repository/Page_AOP/path'))

WebUI.click(findTestObject('Object Repository/Page_AOP/svg'))

WebUI.click(findTestObject('Object Repository/Page_AOP/div_Lacak'))

WebUI.click(findTestObject('Object Repository/Page_AOP/svg_1'))
